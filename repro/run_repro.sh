...
mkdir -p .repro_tmp/gb_closure
cp artifacts/stitch_constants.json .repro_tmp/gb_closure/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/gb_closure/constants_registry.json
