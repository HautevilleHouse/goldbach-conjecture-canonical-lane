...
mkdir -p .codex_tmp/gb_closure
cp artifacts/stitch_constants.json .codex_tmp/gb_closure/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/gb_closure/constants_registry.json

python3 scripts/gb_closure_guard.py       --strict-coh-zero       --registry artifacts/constants_registry.json       --stitch artifacts/stitch_constants.json       --out repro/certificate_runtime.json       --history repro/drift_guard_runs.jsonl       --pretty
