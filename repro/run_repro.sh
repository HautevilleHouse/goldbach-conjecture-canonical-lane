...
mkdir -p .tmp/gb_closure
cp artifacts/stitch_constants.json .tmp/gb_closure/stitch_constants.json
cp artifacts/constants_registry.json .tmp/gb_closure/constants_registry.json
